...
import { am as writable, o as onMount, aa as state, v as get$1, W as set$1, ab as tick, bx as fork, by as settled } from "./Bd2P5WIS.js";
class HttpError {
  /**
   * @param {number} status
...
const base = ((_a = globalThis.__sveltekit_x5m1xv) == null ? void 0 : _a.base) ?? "";
const assets = ((_b = globalThis.__sveltekit_x5m1xv) == null ? void 0 : _b.assets) ?? base ?? "";
const version = "f49a7e7a22331c40985357177f5d7bb262659053";
...
async function start(_app, _target, hydrate) {
  ...
  if ((_a2 = globalThis.__sveltekit_x5m1xv) == null ? void 0 : _a2.data) {
    globalThis.__sveltekit_x5m1xv.data;
  }
